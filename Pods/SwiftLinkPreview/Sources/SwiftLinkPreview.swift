...
open class SwiftLinkPreview: NSObject {
    ...
    @nonobjc @discardableResult open func preview(_ text: String,_ dic: [String:Any], onSuccess: @escaping (Response,[String:Any]) -> Void, onError: @escaping (PreviewError) -> Void) -> Cancellable {
